      ...
      <div className="container mx-auto px-4">
        ...
        <Card className="p-8 mb-12 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground"> Aforv Company (Matryx Medisys)</p>
            </div>
            <div>
        ...
        <Card className="p-8 mb-12 shadow-lg">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                <span className="font-semibold text-primary">RMS - Aforv Company</span>.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            ...
            <div>
              <h3 className="font-semibold mb-2 text-lg">Organization</h3>
              <p className="text-muted-foreground">RMS – Aforv Company</p>
            </div>
            <div>
